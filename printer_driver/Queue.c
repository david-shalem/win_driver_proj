...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, printerdriverQueueInitialize)
#endif

NTSTATUS
printerdriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = printerdriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = printerdriverEvtIoStop;
...
VOID
printerdriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
